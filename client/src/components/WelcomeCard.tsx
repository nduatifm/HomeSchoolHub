...
export default function WelcomeCard({ name, message, buttonText, onButtonClick }: WelcomeCardProps) {
  return (
    <div className="bg-primary rounded-3xl p-8 text-white shadow-xl relative overflow-hidden" data-testid="welcome-card">
