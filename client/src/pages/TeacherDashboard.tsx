...
export default function TeacherDashboard() {
  ...
  const [activeTab, setActiveTab] = useState(() => {
    ...
    return TEACHER_TABS.includes(hash) ? hash : "assignments";
  });
                  ...
                  >
                    <DialogContent>
                      ...
                      <div className="space-y-4">
                        ...
                        <Button
                          onClick={() =>
                            updateAssignmentMutation.mutate(editAssignmentForm)
                          }
                          ...
                          >
                            ...
                            <TableCell>
                              <a
                                ...
                                data-testid={`link-materials-meeting-${sub.assignment?.id}`}
                              >
                                Assignment
                              </a>
                            </TableCell>
                            <TableCell>
                              <a
                                ...
                                rel="noopener noreferrer"
                                className="text-blue-600 hover:underline"
                                data-testid={`link-materials-meeting-${sub.id}`}
                              >
                                Assignment
                              </a>
                            </TableCell>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-2">
                            ...
                            {/* <p className="text-xs text-muted-foreground">
                              Students scoring 70 or above will receive
                              assignment points.
                            </p> */}
                          </div>
                          <div className="space-y-2">
                  ...
                  >
                    <DialogContent>
                      ...
                      <div className="space-y-4">
                        ...
                        <Button
                          onClick={() =>
                            updateMaterialMutation.mutate(editMaterialForm)
                          }
